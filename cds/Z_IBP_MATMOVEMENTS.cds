...
select  key ebeln as DOCID,key le_vbeln   as LE_VBELN ,key werks as LOCFR,key umwrk as LOCID,key matnr as PRDID,charg as BATCHID,key CONCAT(cpudt,cputm) as OTIME , sum(menge) as QTY , 'I' as RECORD_TYPE
from matdoc
...
union
select  ebeln as DOCID, '-' as LE_VBELN ,'-' as LOCFR ,key werks as LOCID,key matnr as PRDID,charg as BATCHID,key CONCAT(cpudt,cputm) as OTIME ,sum(menge) as QTY , 'R' as RECORD_TYPE
from matdoc
