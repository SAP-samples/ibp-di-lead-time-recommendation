...
define view Z_RECEIPTS as select key ebeln as docid, key werks as locid,key matnr as prdid,key charg as batchid,key CONCAT(cpudt,cputm) as otime ,sum(menge) as qty,'R' as SOURCE
from matdoc
